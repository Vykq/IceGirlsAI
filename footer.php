            ...
            <div class="wrapper">
                <div class="social-icons">
                    <?php if(get_field('discord','api')) : ?>
                        <a href="<?php the_field('discord','api'); ?>" target="_blank" aria-label="Discord">
                    ...
                    <?php if(get_field('reddit','api')) : ?>
                        <a href="<?php the_field('reddit','api'); ?>" target="_blank"  aria-label="Reddit">
                    ...
                    <?php if(get_field('twitter','api')) : ?>
                        <a href="<?php the_field('twitter','api'); ?>" target="_blank" aria-label="Twitter">
                    ...
                    <?php if(get_field('patreon','api')) : ?>
                        <a href="<?php the_field('patreon','api'); ?>"  target="_blank" aria-label="Patreon">
                    ...
                    <?php if(get_field('telegram','api')) : ?>
                        <a href="<?php the_field('telegram','api'); ?>"  target="_blank" aria-label="Telegram">
