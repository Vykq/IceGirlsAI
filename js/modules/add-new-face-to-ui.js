import getImageByPostId from "./get-image-by-post-id";

const addNewFaceToUI = async (postid) => {
    ...
    let facesLength = document.querySelectorAll('.saved-faces').length;
    let facesBlocks = document.querySelectorAll('.saved-faces');
    ...
    async function createNewFace(){
        ...
        singleAction.classList.add('user-face');
        singleAction.classList.add('saved-faces');
        singleAction.dataset.id = postid;
        ...
        label.textContent = "Generated face";
        ...
        imgEl.dataset.id = postid;
        imgEl.alt = "User generated face";
        imgEl.classList.add('face-image');
        imgEl.classList.add('face-' + facesLength);
        spinner.append(imgEl);

        try {
            const img = await getImageByPostId(postid);
