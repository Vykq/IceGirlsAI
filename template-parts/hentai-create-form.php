...
<form action="" class="creation-form">
    <div class="form-area">
        <div class="top">
            ...
            <div class="grid">
                <div class="single-btn">
                    <button class="open-modal choose-model secondary-button" data-id="choose-model">Style: Hentai</button>
                </div>
                <div class="single-btn">
    ...
    <?php echo get_template_part('template-parts/modals/checkpoints'); ?>

    <?php wp_reset_postdata(); ?>

    <?php echo get_template_part('template-parts/modals/actions'); ?>

    <?php wp_reset_postdata(); ?>

    <?php echo get_template_part('template-parts/modals/chars'); ?>
